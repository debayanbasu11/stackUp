...
public class TheStack : MonoBehaviour
{
    ...
    private const float BOUNDS_SIZE = 2.6f;
    ...
    private Color32 Lerp5(Color32 a, Color32 b, Color32 c, Color32 d, Color32 e, float t){
        if(t < 0.20f){
            return Color.Lerp(a, b, t / 0.20f);
        }else if(t < 0.50f){
            return Color.Lerp(b, c, (t - 0.20f) / 0.20f);
        }else if(t < 0.75f){
            return Color.Lerp(c, d, (t - 0.50f) / 0.50f);
        }else{
            return Color.Lerp(d, e, (t - 0.70f) / 0.70f);
        }
    }
